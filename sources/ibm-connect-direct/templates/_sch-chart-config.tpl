...
sch:
  chart:
    ...
    podSecurityContext:
      runAsNonRoot: true
      supplementalGroups: {{ .Values.storageSecurity.supplementalGroups | default 5555 }}
    ...
    containerSecurityContext:
      ...
      capabilities:
        drop: [ "ALL" ]
        add: [ "IPC_OWNER", "IPC_LOCK", "CHOWN", "SETGID", "SETUID", "DAC_OVERRIDE", "FOWNER", "AUDIT_WRITE", "SYS_CHROOT" ]
{{- end -}}
